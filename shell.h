...
#define LOWERCASE1_CONV 1
#define UNSIGNED2_CONV 2
 ...
 * @_number: Number field.
 * @str: String object.
 * @nxt: Redirects to next node.
 */
...
int c_putsfd(char *obj1, int obj2);
...
char *c_strcpy(char *obj1, char *obj2/*, size_t length*/);
...
list_t *node_entry(list_t *obj1, char *obj2, char obj3);
